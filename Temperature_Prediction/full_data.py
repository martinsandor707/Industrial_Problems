...
from helper import read_stdata, read_stdata2, my_train_test_split, plot_ens_q, get_coord
from MyNN import TemperatureRegressor, EarlyStopping
...
model = TemperatureRegressor(5, 126)
...
for epoch in range(epoch_number):
    ...
    with torch.no_grad():
        ...
        val_loss += validation_criterion(preds, validation_targets).item()
